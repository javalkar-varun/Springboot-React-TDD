...
describe('apiCalls', () => {
    ...
    describe('listUser', () => {
        ...
        it('calls /api/1.0/users?page=5&size=3 when corresponding params provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
        ...
        it('calls /api/1.0/users?page=0&size=5 when corresponding params provided for listUsers', () => {
            const mockListUsers = jest.fn();
            axios.get = mockListUsers;
